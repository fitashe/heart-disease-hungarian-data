...
# memuat model machine learning yang telah dilatih
model = pickle.load(open("model/xgb_model.pkl", 'rb'))
# with open("model/knn_model.pkl", 'rb') as model_file:
#     model = pickle.load(model_file)

# melakukan prediksi dan evaluasi akurasi model
...
# konten untuk memprediksi multiple data
with tab2:
